...
public class farmer_registration extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String delivery = request.getParameter("available");
        ...
        {    
            ...
            String query="insert into farmer_reg(firstname,uniqueid,email,phonenumber,password,gender,age,address,district,pincode,status,otp,delivery) values (?,?,?,?,?,?,?,?,?,?,?,?,?);";    
